...
function submitPost() {
  ...
  if (title === '' || body === '') {
    ...
    // Determine if add or edit by checking for hidden id
    if (!id) {
      // Create Post
...
var UI = function () {
  ...
  _createClass(UI, [{
    ...
    value: function showPosts(posts) {
      this.post.innerHTML = posts.reduce(function (output, post) {
        return output += '\n        <div class="card mb-3">\n          <div class="card-body">\n            <h4 class="card-title">' + post.title + '</h4>\n            <p class="card-text">' + post.body + '</p>\n            <a href="#" class="edit card-link" data-id="' + post.id + '">\n              <i class="fa fa-pencil"></i>\n            </a>\n            <a href="#" class="delete card-link" data-id="' + post.id + '">\n              <i class="fa fa-remove"></i>\n            </a>\n          </div>\n        </div>\n      ';
      }, '');
    }
  }, {
    ...
    value: function changeFormState(type) {
      if (type === 'edit') {
        ...
        // Get parent and previous element then insert before
        ...
        // Clear ID from hidden field and text fields
        this.clearIdInput();
        this.clearFields();
      }
    }
